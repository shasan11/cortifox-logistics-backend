...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='HistoricalWarehouseJobsOrders',
            fields=[
                ('id', models.IntegerField(blank=True, db_index=True)),
                ('remarks', models.TextField(blank=True, null=True, verbose_name='Remarks')),
                ...
                ('shipment', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='shipments.shipment', verbose_name='Shipment')),
                ('user_add', models.ForeignKey(blank=True, db_constraint=False, default=core.getCurrentUser.get_current_user, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
            ...
            options={
                'verbose_name': 'historical warehouse jobs orders',
                'verbose_name_plural': 'historical warehouse jobs orderss',
                'ordering': ('-history_date', '-history_id'),
                'get_latest_by': ('history_date', 'history_id'),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.DateTimeField(auto_now=True)),
                ('active', models.BooleanField(default=True)),
                ('from_warehouse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='warehouse_order_stock_transfers_from', to='warehouse.warehouse', verbose_name='From Warehouse')),
                ('from_warehouse_bin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='warehouse_order_stock_transfers_from_bins', to='warehouse.warehousebin', verbose_name='From Warehouse Bin')),
                ('port_destination', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='warehouse_order_port_destination', to='master.ports')),
                ('port_handling_agent_destination', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='warehouse_orders_port_handling_agent_destination', to='actor.vendor')),
                ('port_handling_agent_origin', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='warehouse_order_handling_agent_origin', to='actor.vendor')),
                ('port_origin', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='warehouse_order_port_origin', to='master.ports')),
                ('shipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='warehouse_orders_shipments', to='shipments.shipment', verbose_name='Shipment')),
                ('to_warehouse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='warehouse_order_stock_transfers_to', to='warehouse.warehouse', verbose_name='To Warehouse')),
                ('to_warehouse_bin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='warehouse_order_stock_transfers_to_bins', to='warehouse.warehousebin', verbose_name='To Warehouse Bin')),
                ('user_add', models.ForeignKey(default=core.getCurrentUser.get_current_user, editable=False, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='warehouse_job_user_add', to=settings.AUTH_USER_MODEL)),
                ('warehouse_bin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='warehouse_orders_warehouses_bin', to='warehouse.warehousebin', verbose_name='Warehouse Bin')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('user_add', models.ForeignKey(blank=True, db_constraint=False, default=core.getCurrentUser.get_current_user, editable=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to=settings.AUTH_USER_MODEL)),
                ('warehouse_orders', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='warehouse.warehousejobsorders')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warehouse_orders', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='GRN_WAREHOUSE_ORDER', to='warehouse.warehousejobsorders')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warehouse_orders', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='GIO_WAREHOUSE_ORDER', to='warehouse.warehousejobsorders')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warehouse_orders', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='GDO_WAREHOUSE_ORDER', to='warehouse.warehousejobsorders')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ASN_WAREHOUSE_ORDER', to='warehouse.warehousejobsorders'),
        ),
        migrations.CreateModel(
